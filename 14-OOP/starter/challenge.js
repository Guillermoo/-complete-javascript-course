...
/* Object Oriented Programming (OOP) Coding Challenge 
...
class CarCl {
  constructor(make, speed) {
    this.make = make;
    this.speed = speed; //Se guarda en km/h
  }
...
// Polymorphismo. Modificamos el metodo heredado.
...
rivian.accelerate();
// console.log(rivian);
rivian.accelerate().chargeBattery(85);
console.log(rivian);
console.log(rivian.speedUS);

// rivian.brake().brake().chargeBattery(20).accelerate();
